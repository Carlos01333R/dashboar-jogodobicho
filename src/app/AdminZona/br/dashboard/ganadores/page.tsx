...
const GanadoresHistoryAdminZona: React.FC = () => {
            ...
            <div className="flex items-center justify-between">
              <div className="pr-3">
                ...
                <p className="text-xl font-bold text-gray-900 truncate">
                  {FormatCurrencyBR(summary?.resumen.total_premios || 0)}
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="pr-3">
                ...
                <p className="text-xl font-bold text-gray-900 truncate">
                  {FormatCurrencyBR(summary?.resumen.premio_promedio || 0)}
                </p>
              </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold text-emerald-600">{FormatCurrencyBR(winner.premio_total)}</span>
                </div>
...
export default GanadoresHistoryAdminZona
