...
import VistaInfo from "./VentasUser";
  ...
  return (
    <>
      <section className="w-full flex flex-col px-3 py-2 justify-center items-center">
        ...
        {selectedUserData && fechaSeleccionada && selectedCountry === 'colombia' ? (
        <VistaInfo
       ...
       {selectedUserData && fechaSeleccionada && selectedCountry === 'brazil' && (
       <>
     
         <VistaInfo
          selectUser={selectedUserData.email}
          fechaSeleccionada={formatDateToMMDDYYYYBrasil(date)}
          sector={selectedUserData.sector}
          country={selectedCountry}
        />
        </>
